...
const PAST_LAUNCHES = [
  ...
  // 2009: 1 launch
  { id: '2009-1', name: 'Falcon 1', date_utc: new Date(2009, 0, 1).toISOString(), success: true, upcoming: false, rocket: { id: 'falcon1', name: 'Falcon 1' }, links: { patch: { large: null } }, payloads: [{ mass_kg: 335, type: 'Satellite' }] },
  // 2008: 2 launches
  ...Array(2).fill(null).map((_, i) => ({
    id: `2008-${i}`,
    name: 'Falcon 1',
